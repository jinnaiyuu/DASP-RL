...
//		m_env->set_player_B(m_player_B);
		reward_t curr_reward = m_env->act(a, PLAYER_B_NOOP);
//		if (m_player_B)
...
std::vector<bool> SearchTree::getUsefulActions(std::vector<Action> previousActions) {
